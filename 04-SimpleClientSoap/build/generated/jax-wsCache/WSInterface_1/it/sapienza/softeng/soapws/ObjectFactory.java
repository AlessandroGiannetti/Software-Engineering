 ...
 * generated in the it.sapienza.softeng.soapws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Hello_QNAME = new QName("http://soapws.softeng.sapienza.it/", "hello");
    private final static QName _HelloStudentResponse_QNAME = new QName("http://soapws.softeng.sapienza.it/", "helloStudentResponse");
    private final static QName _GetStudents_QNAME = new QName("http://soapws.softeng.sapienza.it/", "getStudents");
    private final static QName _HelloStudent_QNAME = new QName("http://soapws.softeng.sapienza.it/", "helloStudent");
    private final static QName _HelloResponse_QNAME = new QName("http://soapws.softeng.sapienza.it/", "helloResponse");
    private final static QName _GetStudentsResponse_QNAME = new QName("http://soapws.softeng.sapienza.it/", "getStudentsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.sapienza.softeng.soapws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "helloStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "getStudents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "helloStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "helloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapws.softeng.sapienza.it/", name = "getStudentsResponse")
